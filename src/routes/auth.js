...
router.get('/admin/usuarios/unique', authorizeRoles('admin'), usersController.checkUnique);

router.put('/admin/usuarios/:id/password', authMiddleware, authorizeRoles('admin'), usersController.adminSetPassword);
